...
# =============================================================================
        ...
        date = init_date[0].split()
        #   print("SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS",date)
        year, month, day = [int(i) for i in str(datetime.now().date()).split(sep='-')] #default is today
        ...
        #Yesterday, Now, 4hr, 50mins
            ...
            if date[0].isalpha():
                print("COKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK",date[0].lower())
...
class CommentsItem(scrapy.Item):
    ...
    angry = scrapy.Field()
    share = scrapy.Field()  
    post_id = scrapy.Field()                    # num of shares
